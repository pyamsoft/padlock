...
class LockListPresenterImpl extends SchedulerPresenter<Presenter.Empty>
  ...
  @Override public void populateList(@NonNull PopulateListCallback callback) {
  ...
  @Override public void setFABStateFromPreference(@NonNull FABStateCallback callback) {
  ...
  @Override public void clickPinFABServiceIdle(@NonNull ShowAccessibilityCallback callback) {
    callback.onCreateAccessibilityDialog();
  }

  @Override public void clickPinFABServiceRunning(@NonNull ShowPinCallback callback) {
