...
class LockInfoInteractorImpl extends LockCommonInteractorImpl implements LockInfoInteractor {
  ...
  @Override public void updateCacheEntry(@NonNull String packageName, @NonNull String name,
  ...
  @NonNull @Override public Observable<ActivityEntry> populateList(@NonNull String packageName) {
