...
import com.pyamsoft.padlock.base.BuildConfig;
import com.pyamsoft.padlock.base.TestUtils;
...
public class PadLockDBTest {
  ...
  @Test public void testInsertNull() throws Exception {
    try {
      ...
      TestUtils.expected("NullPointerException in testInsert with NULL information");
    }
  }
  ...
  @Test public void testInsertEmpty() throws Exception {
    try {
      ...
      TestUtils.expected("RuntimeException in testInsert with NULL information");
    }
  }
