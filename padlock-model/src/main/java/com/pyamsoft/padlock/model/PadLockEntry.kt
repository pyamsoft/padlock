...
@AutoValue abstract class PadLockEntry : PadLockEntryModel {
    ...
    class InsertManager constructor(openHelper: SQLiteOpenHelper) {
    ...
    class DeletePackageManager constructor(openHelper: SQLiteOpenHelper) {
    ...
    class DeletePackageActivityManager constructor(openHelper: SQLiteOpenHelper) {
    ...
    class UpdateLockTimeManager constructor(openHelper: SQLiteOpenHelper) {
    ...
    class UpdateIgnoreTimeManager constructor(openHelper: SQLiteOpenHelper) {
    ...
    class UpdateWhitelistManager constructor(openHelper: SQLiteOpenHelper) {
    ...
    companion object {
        ...
        val EMPTY: PadLockEntry by lazy {
            AutoValue_PadLockEntry(PACKAGE_EMPTY,
                    ACTIVITY_EMPTY, null, 0, 0,
                    false, false)
        }
        ...
        val ALL_ENTRIES_MAPPER: RowMapper<AllEntries> by lazy<RowMapper<AllEntries>> {
        ...
        val WITH_PACKAGE_NAME_MAPPER: RowMapper<WithPackageName> by lazy<RowMapper<WithPackageName>> {
            FACTORY.with_package_nameMapper { activityName, whitelist ->
                AutoValue_PadLockEntry_WithPackageName(activityName, whitelist)
            }
        }

        val WITH_PACKAGE_ACTIVITY_NAME_DEFAULT_MAPPER: PadLockEntryModel.Mapper<PadLockEntry> by lazy {
            FACTORY.with_package_activity_name_defaultMapper()
        }

        @CheckResult
        fun withPackageActivityNameDefault(packageName: String,
                activityName: String): SqlDelightStatement {
            return FACTORY.with_package_activity_name_default(packageName,
                    PACKAGE_ACTIVITY_NAME,
                    activityName,
                    PACKAGE_ACTIVITY_NAME, activityName)
        }

        @CheckResult
        fun withPackageName(packageName: String): SqlDelightStatement =
                FACTORY.with_package_name(packageName)

        @CheckResult
        fun queryAll(): SqlDelightStatement = FACTORY.all_entries()
        ...
        @CheckResult
        fun insertEntry(openHelper: SQLiteOpenHelper): InsertManager {
        ...
        @CheckResult
        fun deletePackage(openHelper: SQLiteOpenHelper): DeletePackageManager {
        ...
        fun deletePackageActivity(
            ...
            return if (obj == null) {
                val dpam = DeletePackageActivityManager(
                        openHelper)
        ...
        @CheckResult
        fun updateLockTime(openHelper: SQLiteOpenHelper): UpdateLockTimeManager {
        ...
        @CheckResult
        fun updateIgnoreTime(openHelper: SQLiteOpenHelper): UpdateIgnoreTimeManager {
            val obj: UpdateIgnoreTimeManager? = updateIgnoreTimeManager
            return if (obj == null) {
                val uitm = UpdateIgnoreTimeManager(
                        openHelper)
        ...
        @CheckResult
        fun updateWhitelist(openHelper: SQLiteOpenHelper): UpdateWhitelistManager {
